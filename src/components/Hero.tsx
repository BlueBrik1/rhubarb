...
const headlineLine1 = ["Just learn", "syntax."];
const headlineLine2 = ["Brutal.", "💔"];
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center text-center">
        ...
        <div className="hero-card origin-top-left relative mx-auto mt-10 w-full max-w-2xl rounded-2xl border border-rhubarb-900/10 bg-rhubarb-950 p-6 text-left font-mono text-sm shadow-2xl shadow-rhubarb-900/30">
          ...
          <pre className="overflow-x-auto leading-relaxed text-custard-100">
{`⸘lաgyբn⸘ néա ⟜ "rhubarb" ∫
...
Elաelբápգszդásեalզníէhaըatթanժágիskլdáխaiծokկrt kiաltբs ⟪hաváբ⟫ szա ⟪vաgeբ ∫
    ⸘vաssբa⸘ szա.nաgyբetգ⟪hաváբ⟫⟪vաgeբ + "Hello World!" ∫`}
        ...
        <p className="hero-sub mt-10 max-w-md text-lg leading-relaxed text-rhubarb-900/70">
          Rhubarb is a language and its own IDE, rolled into one download. It's
          unbelievably easy — you write a few friendly little squiggles like{" "}
          <code className="rounded bg-rhubarb-900/5 px-1.5 py-0.5 font-mono text-base text-rhubarb-700">
            ⸘kաpdբ
          </code>
          , hit compile, and it just becomes real Python. Zero learning curve.
          No documentation required. (There is documentation. It's huge.)
        </p>

        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <a
            href="#install"
            className="hero-cta rounded-full bg-rhubarb-600 px-7 py-3.5 font-semibold text-custard-50 shadow-lg shadow-rhubarb-600/25 transition-transform duration-200 hover:-translate-y-0.5 hover:bg-rhubarb-700"
          >
            Get the IDE
          </a>
          <Link
            to="/docs"
            className="hero-cta rounded-full border-2 border-rhubarb-900/15 px-[1.625rem] py-3 font-semibold text-rhubarb-900 transition-colors duration-200 hover:border-rhubarb-900/30"
          >
            Read the docs
          </Link>
        </div>
